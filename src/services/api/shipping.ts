...
export const searchShippingDestinations = (search: string, offset = 0) =>
  api<ShippingDestination[]>(`/api/shipping/destinations?search=${encodeURIComponent(search)}&offset=${offset}`);
